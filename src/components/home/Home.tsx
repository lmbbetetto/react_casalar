      ...
      <section className="sec_home">
        <div className="sobreHome">
          ...
          <p>
            ...
            desenvolve o Serviço de Convivência e Fortalecimento de Vínculos
            para Jovens, com foco na qualificação e inserção no mundo do
            trabalho, conforme a Lei do Aprendiz nº. 10.097/2000.
          </p>
          <p>
